...
void Solutio17404() {
	...
	min_cost_of_house_end_with_color[1][0] = cost_of_R;		// R로 시작했을 때
	min_cost_of_house_end_with_color[1][1] = cost_of_G;		// G로 시작했을 때
	min_cost_of_house_end_with_color[1][2] = cost_of_B;		// B로 시작했을 때
